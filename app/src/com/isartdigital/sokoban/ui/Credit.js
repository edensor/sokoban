//La Class Credit extends Screen
define(['jquery','utils/ui/Screen','sokoban/game/abstrait/score','utils/Config'],function($,Screen,score,Config){
	...
	function setMethode(){
		...
		this.getMessage =  function(){
			var message = "<p>Made by<br>Marco Martella and Robin Mignot</p>";
			return message;
		}
	}

	Credit.prototype =  Object.create(Screen.prototype); //ici on recupère les methodes de Screen.
	setMethode.call(Credit.prototype);
	Credit.prototype.Constructer = Credit;
